...
trait EncoderFallbackInstance:
  ...
  /** Fallback instance used to make the tests compile when user instances are missing */
  given encoderSentinel[A] as Encoder[A] =
...
trait DecoderFallbackInstance:
  ...
  /** Fallback instance used to make the tests compile when user instances are missing */
  given decoderSentinel[A] as Decoder[A] =
